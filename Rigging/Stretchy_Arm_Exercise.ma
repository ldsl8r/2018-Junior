...
//Last modified: Sat, Sep 29, 2018 04:55:44 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.5390871715270604 9.3234668329658827 9.1689822299168249 ;
	setAttr ".r" -type "double3" -26.138352729607654 11.000000000001 8.1002103830621477e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5D282A72-45AA-3615-269F-7C846E521D29";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 12.95163419812846;
...
createNode joint -n "L_arm_01_jnt" -p "Skeleton";
	...
	setAttr ".r" -type "double3" -1.3320037172353705e-14 4.4174027717312269e-15 -5.1347559649906957e-31 ;
...
createNode joint -n "L_arm_02_jnt" -p "L_arm_01_jnt";
	...
	setAttr ".t" -type "double3" 3.164699898447719 0 0 ;
	setAttr ".r" -type "double3" 0 0 1.9728610706871171e-13 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "xzy";
...
createNode joint -n "L_arm_03_jnt" -p "L_arm_02_jnt";
	...
	setAttr ".t" -type "double3" 3.1574829746975532 -4.5782719449244206e-16 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".radi" 0.61159394696711489;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "75DB27D4-435A-2585-843E-778DAE5A1052";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "022488C7-4B53-CA82-AD37-3B88B8C86BE6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "24050F85-475F-47BC-CE40-64A75FDED2C0";
createNode displayLayerManager -n "layerManager";
	rename -uid "F197E9B5-4E55-B0C9-71FF-C5B58BD9B713";
createNode displayLayer -n "defaultLayer";
	rename -uid "FD571A4C-4BF4-5D14-3A6F-F490640F8146";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A0DDA649-4C0B-009C-EE94-9D90877BEF30";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "84C9D659-4E4D-8C57-CCDC-A389D9124F44";
	setAttr ".pee" yes;
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -2011.8055034946963 -141.91977927905344 ;
	setAttr ".tgi[0].vh" -type "double2" -331.89224582694027 479.54228093827061 ;
	setAttr -s 7 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -1353.96337890625;
	setAttr ".tgi[0].ni[0].y" 272.87667846679688;
	setAttr ".tgi[0].ni[0].nvs" 18306;
	setAttr ".tgi[0].ni[1].x" -1884.4774169921875;
	setAttr ".tgi[0].ni[1].y" 153.10714721679688;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" -1621.4827880859375;
	setAttr ".tgi[0].ni[2].y" 267.26968383789063;
	setAttr ".tgi[0].ni[2].nvs" 1923;
	setAttr ".tgi[0].ni[3].x" -1897.0963134765625;
	setAttr ".tgi[0].ni[3].y" 373.8621826171875;
	setAttr ".tgi[0].ni[3].nvs" 18304;
	setAttr ".tgi[0].ni[4].x" -1892.8424072265625;
	setAttr ".tgi[0].ni[4].y" 235.40927124023438;
	setAttr ".tgi[0].ni[4].nvs" 18304;
	setAttr ".tgi[0].ni[5].x" -1668.737060546875;
	setAttr ".tgi[0].ni[5].y" 354.85537719726563;
	setAttr ".tgi[0].ni[5].nvs" 18304;
	setAttr ".tgi[0].ni[6].x" -1896.6212158203125;
	setAttr ".tgi[0].ni[6].y" 305.85592651367188;
...
connectAttr "L_arm_Length_Joint_PMA.o1" "L_Arm_Stretchy_Scaler_MD.i2x";
connectAttr "L_Arm_Stretchy_Scaler_MD.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "L_arm_IK_Distance_02_LocatorShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "L_Arm_Distance_DB.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "L_Arm_Joint_02_Length_MD.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "L_arm_IK_Distance_01_LocatorShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "L_arm_Length_Joint_PMA.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
