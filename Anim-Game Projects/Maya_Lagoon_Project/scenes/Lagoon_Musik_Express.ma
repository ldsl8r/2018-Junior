...
//Last modified: Tue, Feb 26, 2019 08:44:36 AM
//Codeset: 1252
requires maya "2018";
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "Musik_Express1";
...
createNode mesh -n "Musik_Express1Shape" -p "Musik_Express1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A7B09A62-46EC-8A76-212E-10BE080F9659";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1AA36A3B-4A26-0250-C27B-DF97160E72C2";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "734EE82B-4D32-08AD-9E71-7B9F75EA3285";
createNode displayLayerManager -n "layerManager";
	rename -uid "6F2FF723-4A29-791F-528E-AE82CB0A9FEF";
createNode displayLayer -n "defaultLayer";
	rename -uid "2D0AFB53-41CD-54F4-3E82-84836B3AC11C";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "480EABEB-4953-00C4-0621-5CBBD3D90B79";
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "groupId1.id" "Musik_Express1Shape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Musik_Express1Shape.iog.og[0].gco";
...
connectAttr "Musik_Express1Shape.iog.og[0]" ":initialShadingGroup.dsm" -na;
