...
//Last modified: Mon, Dec 17, 2018 03:07:10 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -30.10910433107377 47.323103907834749 165.40665264588355 ;
	setAttr ".r" -type "double3" 353.06164727112338 -9.7999999999996259 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "A08EF60E-49E3-1850-B69F-2EBA26E2CB3A";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 168.73256391199794;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.86419129424692365 17.532960845679973 1002.8913375954144 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "7F0A1425-4C1A-1FEA-F530-BD9756437021";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1002.8913375954144;
	setAttr ".ow" 91.672256974883652;
...
createNode mesh -n "Turn_Of_The_CenturyShape" -p "Turn_Of_The_Century";
	...
	setAttr ".ed[0:165]"  0 1 0 1 2 0 2 3 0 3 4 0 4 5 0 5 6 0 6 7 0 7 8 0 8 9 0
		 ...
		 60 49 1 61 62 0 62 63 0 63 64 0 64 65 0 65 66 0 66 67 0 67 68 0 68 61 0 69 70 1 70 71 1
		 71 72 1 72 73 1 73 74 1 74 75 1 75 76 1 76 69 1 77 78 1 78 79 1 79 80 1 80 81 1 81 82 1
	...
	setAttr ".ed[166:231]" 107 108 1 108 101 1 109 110 0 110 111 0 111 112 0 112 113 0
		 ...
		 106 114 0 107 115 0 108 116 0 117 118 1 118 119 1 119 120 1 120 121 1 121 122 1 122 123 1
		 123 124 1 124 117 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1FACECAF-4D8E-A01B-47FF-168AB2A979AB";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "14182F07-4329-962F-95A8-529368ABBA9E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BAAB0858-4217-C12C-8325-53A301193176";
createNode displayLayerManager -n "layerManager";
	rename -uid "13CDF846-4855-ACBC-DD06-EDA4A1552CAC";
createNode displayLayer -n "defaultLayer";
	rename -uid "B97B6CFA-4190-9632-C90C-F9BBB4313081";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D8F0A4EA-446C-2829-28CE-9EB7D86931ED";
...
createNode groupId -n "groupId1";
	rename -uid "1043CC99-45E3-2A95-8A41-96903078A1FA";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
