...
//Name: Lamborghini.ma
//Last modified: Sun, Jan 13, 2019 05:27:49 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.040623747045804 7.6849363914402042 16.366931474051452 ;
	setAttr ".r" -type "double3" -17.73835273006064 347.79999999991384 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "60068920-4E51-D636-8665-A2B135637F94";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.23764300917162;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.1128402111211413 2.6475570205093724 1000.1403895825235 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "B0749531-4F32-559F-8A7A-068FF990DFF8";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 999.91654661397001;
	setAttr ".ow" 6.0579394270563736;
...
createNode imagePlane -n "Left_Side_ViewShape" -p "Left_Side_View";
	...
	setAttr -k off ".v";
	setAttr ".fc" 101;
	setAttr ".imn" -type "string" "D:/2018-Junior/2019 Senior Project/Reference Material/lamborghini countach side view.jpg";
...
createNode imagePlane -n "Back_ViewShape" -p "Back_View";
	...
	setAttr -k off ".v";
	setAttr ".fc" 101;
	setAttr ".imn" -type "string" "D:/2018-Junior/2019 Senior Project/Reference Material/lamborghini countach back view.jpg";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "8473E138-4D29-1C17-498F-48B0D97DF5EF";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "66D05A9B-4792-3345-9C3D-9CB004DAECD6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4F32D347-4D92-C93B-5288-D0B444430315";
createNode displayLayerManager -n "layerManager";
	rename -uid "26C79655-4726-C84C-FA72-90BAED1CB8E8";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B68B00C7-4E9B-8806-76E4-74A471BA7F6B";
...
createNode polyTweak -n "polyTweak2";
	...
	setAttr ".uopa" yes;
	setAttr -s 15 ".tk";
	setAttr ".tk[172]" -type "float3" 0.0023100683 0.016926285 -0.065906428 ;
	setAttr ".tk[173]" -type "float3" 5.8940706e-05 -0.046890739 -0.066029504 ;
	setAttr ".tk[174]" -type "float3" 0.0023100683 0.016926285 0.06590642 ;
	setAttr ".tk[175]" -type "float3" 5.8940706e-05 -0.046890739 0.066029489 ;
	setAttr ".tk[176]" -type "float3" -0.00094981102 -0.075487845 -0.068994433 ;
	setAttr ".tk[177]" -type "float3" -0.00094981102 -0.075487845 0.068994395 ;
	setAttr ".tk[178]" -type "float3" -0.001815513 -0.10002965 -0.07136637 ;
	setAttr ".tk[179]" -type "float3" -0.001815513 -0.10002965 0.07136634 ;
	setAttr ".tk[180]" -type "float3" -0.0019461469 -0.11663155 -0.07136637 ;
	setAttr ".tk[181]" -type "float3" -0.0019461469 -0.11663155 0.071366347 ;
	setAttr ".tk[182]" -type "float3" -0.0021533573 -0.14296652 -0.07136637 ;
	setAttr ".tk[183]" -type "float3" -0.0021533573 -0.14296652 0.07136634 ;
	setAttr ".tk[184]" -type "float3" -0.0023100679 -0.16288292 -0.07136637 ;
	setAttr ".tk[185]" -type "float3" -0.0023100679 -0.16288292 0.071366347 ;
...
createNode polyTweak -n "polyTweak3";
	...
	setAttr ".uopa" yes;
	setAttr -s 11 ".tk";
	setAttr ".tk[186]" -type "float3" -5.8940674e-05 0.010386034 -0.036105808 ;
	setAttr ".tk[187]" -type "float3" -2.3705368e-05 0.033451825 -0.039806686 ;
	setAttr ".tk[188]" -type "float3" -5.8940674e-05 0.010386034 0.036105793 ;
	setAttr ".tk[189]" -type "float3" -2.3705368e-05 0.033451825 0.039806671 ;
	setAttr ".tk[190]" -type "float3" 6.5333797e-06 0.053246532 -0.042767443 ;
	setAttr ".tk[191]" -type "float3" 6.5333797e-06 0.053246532 0.042767398 ;
	setAttr ".tk[192]" -type "float3" 2.679713e-05 0.045376725 -0.042767443 ;
	setAttr ".tk[193]" -type "float3" 2.679713e-05 0.045376725 0.042767398 ;
	setAttr ".tk[194]" -type "float3" 5.8940725e-05 0.032892846 -0.042767443 ;
	setAttr ".tk[195]" -type "float3" 5.8940725e-05 0.032892846 0.042767398 ;
...
createNode polyTweak -n "polyTweak4";
	...
	setAttr ".uopa" yes;
	setAttr -s 12 ".tk";
	setAttr ".tk[196]" -type "float3" 5.8940681e-05 0.073209077 -0.059107658 ;
	setAttr ".tk[197]" -type "float3" 2.3705372e-05 0.084387757 -0.060558118 ;
	setAttr ".tk[198]" -type "float3" 5.8940681e-05 0.073209077 0.059107658 ;
	setAttr ".tk[199]" -type "float3" 2.3705372e-05 0.084387757 0.060558107 ;
	setAttr ".tk[200]" -type "float3" -6.5333465e-06 0.093981147 -0.061718468 ;
	setAttr ".tk[201]" -type "float3" -6.5333465e-06 0.093981147 0.061718456 ;
	setAttr ".tk[202]" -type "float3" -2.679709e-05 0.09016709 -0.061718468 ;
	setAttr ".tk[203]" -type "float3" -2.679709e-05 0.09016709 0.061718456 ;
	setAttr ".tk[204]" -type "float3" -5.8940666e-05 0.084116869 -0.061718468 ;
	setAttr ".tk[205]" -type "float3" -5.8940666e-05 0.084116869 0.061718456 ;
