...
//Last modified: Mon, Jun 03, 2019 10:28:54 AM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.496843953916585 4.1135738525222258 12.673954909955043 ;
	setAttr ".r" -type "double3" -15.33835273286487 -351.80000000003042 2.0083798881403343e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "3E00C0AB-449A-9CA8-1EDE-19949D3FCCAC";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.233368548232006;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.67593946586762232 0.25525320959949738 1000.1065387326678 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "112FD145-4282-07EE-C0E4-C096A21A4F05";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1065387326678;
	setAttr ".ow" 4.974724423827884;
	setAttr ".imn" -type "string" "front";
	setAttr ".den" -type "string" "front_depth";
	setAttr ".man" -type "string" "front_mask";
	setAttr ".tp" -type "double3" 2.792565270254673 -0.2143787480195507 0 ;
	setAttr ".hc" -type "string" "viewSet -f %camera";
	setAttr ".o" yes;
createNode transform -s -n "side";
	rename -uid "0C536030-4FEF-9C8E-9E13-819179E73995";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1000225255289 0.21267536036330092 2.2293055320918479e-13 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "BBE3ADAD-4F77-2F82-F03F-E6B5FBCF3332";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1003.9899563623832;
	setAttr ".ow" 0.6485891357470982;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" -3.8899338368543397 0.21267536036330092 0 ;
...
createNode mesh -n "BodyShape" -p "Body";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt";
	setAttr ".pt[2]" -type "float3" 0 0 -0.053901069 ;
	setAttr ".pt[3]" -type "float3" 0 0 -0.053901069 ;
	setAttr ".pt[4]" -type "float3" 0 0 0.053901069 ;
	setAttr ".pt[5]" -type "float3" 0 0 0.053901069 ;
	setAttr ".pt[12]" -type "float3" 0 0 -0.053901069 ;
	setAttr ".pt[13]" -type "float3" 0 0 0.053901069 ;
	setAttr ".pt[14]" -type "float3" 0 0 0.053901069 ;
	setAttr ".pt[15]" -type "float3" 0 0 -0.053901069 ;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 5 ".pt";
	setAttr ".pt[20]" -type "float3" 0.031932898 -0.23700944 0.053309627 ;
	setAttr ".pt[21]" -type "float3" 0.031932898 -0.23700944 -0.053309627 ;
	setAttr ".pt[22]" -type "float3" -0.031932894 -0.23700944 0.053309627 ;
	setAttr ".pt[23]" -type "float3" -0.031932894 -0.23700944 -0.053309627 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 19 ".pt";
	setAttr ".pt[1]" -type "float3" 0 0 -0.061225519 ;
	setAttr ".pt[2]" -type "float3" -0.0020499541 -0.83377355 0 ;
	setAttr ".pt[3]" -type "float3" -0.00063519669 -0.25835234 -0.061225519 ;
	setAttr ".pt[4]" -type "float3" -0.0020499541 -0.83377355 0 ;
	setAttr ".pt[5]" -type "float3" -0.00063519669 -0.25835234 0.061225519 ;
	setAttr ".pt[7]" -type "float3" 0 0 0.061225519 ;
	setAttr ".pt[8]" -type "float3" -0.00080843212 -0.32881203 0.0057973871 ;
	setAttr ".pt[9]" -type "float3" -0.00080843212 -0.32881203 -0.0057973871 ;
	setAttr ".pt[10]" -type "float3" 0 0 -0.0057973871 ;
	setAttr ".pt[11]" -type "float3" 0 0 0.0057973871 ;
	setAttr ".pt[12]" -type "float3" 0 0 0.11469882 ;
	setAttr ".pt[13]" -type "float3" 0 0 -0.11469882 ;
	setAttr ".pt[14]" -type "float3" 0 0 -0.11469882 ;
	setAttr ".pt[15]" -type "float3" 0 0 0.11469882 ;
	setAttr ".pt[16]" -type "float3" 0 0 0.11469882 ;
	setAttr ".pt[17]" -type "float3" 0 0 -0.11469882 ;
	setAttr ".pt[18]" -type "float3" 0 0 -0.11469882 ;
	setAttr ".pt[19]" -type "float3" 0 0 0.11469882 ;
	setAttr ".dr" 1;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4043C14D-43B5-B81F-EBB5-D3AB126923E8";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "492E49A2-42D0-CFCD-EBB3-2E9DFAD847C7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9020B98B-4E6E-9090-DFA2-3590CC92EC2F";
createNode displayLayerManager -n "layerManager";
	rename -uid "E9C8DD4D-4D80-CCCC-339F-50959D35EAD4";
createNode displayLayer -n "defaultLayer";
	rename -uid "446641C8-4B97-EBD8-3DC2-FE834D83D1A5";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "530142A5-4A92-74DE-955F-41ACE09BB658";
...
createNode polyTweak -n "polyTweak1";
	...
	setAttr ".uopa" yes;
	setAttr -s 16 ".tk";
	setAttr ".tk[25]" -type "float3" -1.4901161e-08 0.0036742981 1.4901161e-08 ;
	setAttr ".tk[26]" -type "float3" -3.7252903e-08 0.0036742981 2.9802322e-08 ;
	setAttr ".tk[27]" -type "float3" -3.1331031e-18 0.0036742981 0 ;
	setAttr ".tk[28]" -type "float3" -3.1331031e-18 0.0036742981 2.9802322e-08 ;
	setAttr ".tk[29]" -type "float3" 1.4901161e-08 0.0036742981 2.9802322e-08 ;
	setAttr ".tk[30]" -type "float3" 1.4901161e-08 0.0036742981 1.4901161e-08 ;
	setAttr ".tk[31]" -type "float3" 2.9802322e-08 0.0036742981 0 ;
	setAttr ".tk[32]" -type "float3" 1.4901161e-08 0.0036742981 -1.4901161e-08 ;
	setAttr ".tk[33]" -type "float3" 1.4901161e-08 0.0036742981 -2.9802322e-08 ;
	setAttr ".tk[34]" -type "float3" -3.1331031e-18 0.0036742981 -2.9802322e-08 ;
	setAttr ".tk[35]" -type "float3" -3.7252903e-08 0.0036742981 -2.9802322e-08 ;
	setAttr ".tk[36]" -type "float3" -1.4901161e-08 0.0036742981 -1.4901161e-08 ;
	setAttr ".tk[37]" -type "float3" -4.4703484e-08 0.0036742981 0 ;
...
createNode polyTweak -n "polyTweak2";
	...
	setAttr ".uopa" yes;
	setAttr -s 14 ".tk";
	setAttr ".tk[37]" -type "float3" 0.17355044 -4.3680764e-08 -0.10019936 ;
	setAttr ".tk[38]" -type "float3" 0.10019941 -4.3680764e-08 -0.17355046 ;
	setAttr ".tk[39]" -type "float3" -1.1944695e-08 -4.3680764e-08 0 ;
	setAttr ".tk[40]" -type "float3" -1.1944695e-08 -4.3680764e-08 -0.20039873 ;
	setAttr ".tk[41]" -type "float3" -0.10019941 -4.3680764e-08 -0.17355046 ;
	setAttr ".tk[42]" -type "float3" -0.17355046 -4.3680764e-08 -0.10019936 ;
	setAttr ".tk[43]" -type "float3" -0.20039879 -4.3680764e-08 0 ;
	setAttr ".tk[44]" -type "float3" -0.17355046 -4.3680764e-08 0.10019936 ;
	setAttr ".tk[45]" -type "float3" -0.10019941 -4.3680764e-08 0.17355046 ;
	setAttr ".tk[46]" -type "float3" -1.1944695e-08 -4.3680764e-08 0.20039873 ;
	setAttr ".tk[47]" -type "float3" 0.10019941 -4.3680764e-08 0.17355046 ;
	setAttr ".tk[48]" -type "float3" 0.17355044 -4.3680764e-08 0.10019936 ;
	setAttr ".tk[49]" -type "float3" 0.20039883 -4.3680764e-08 0 ;
...
createNode polyTweak -n "polyTweak16";
	...
	setAttr ".uopa" yes;
	setAttr -s 13 ".tk";
	setAttr ".tk[50]" -type "float3" -0.39870453 0 0 ;
	setAttr ".tk[51]" -type "float3" -0.34528744 0 -0.19935225 ;
	setAttr ".tk[52]" -type "float3" -0.19935228 0 -0.34528744 ;
	setAttr ".tk[53]" -type "float3" -7.9189114e-08 0 -0.3987045 ;
	setAttr ".tk[54]" -type "float3" 0.19935222 0 -0.34528744 ;
	setAttr ".tk[55]" -type "float3" 0.34528741 0 -0.19935225 ;
	setAttr ".tk[56]" -type "float3" 0.39870453 0 0 ;
	setAttr ".tk[57]" -type "float3" 0.34528741 0 0.19935225 ;
	setAttr ".tk[58]" -type "float3" 0.19935222 0 0.34528744 ;
	setAttr ".tk[59]" -type "float3" -7.9189114e-08 0 0.3987045 ;
	setAttr ".tk[60]" -type "float3" -0.19935228 0 0.34528744 ;
	setAttr ".tk[61]" -type "float3" -0.34528744 0 0.19935225 ;
...
createNode polyTweak -n "polyTweak18";
	...
	setAttr ".uopa" yes;
	setAttr -s 14 ".tk";
	setAttr ".tk[73]" -type "float3" 0.076447807 -1.0105466e-08 -0.04413718 ;
	setAttr ".tk[74]" -type "float3" 0.04413718 -1.0105466e-08 -0.07644783 ;
	setAttr ".tk[75]" -type "float3" -1.5784687e-08 -1.0105466e-08 0 ;
	setAttr ".tk[76]" -type "float3" -1.5784687e-08 -1.0105466e-08 -0.08827436 ;
	setAttr ".tk[77]" -type "float3" -0.044137206 -1.0105466e-08 -0.07644783 ;
	setAttr ".tk[78]" -type "float3" -0.076447845 -1.0105466e-08 -0.04413718 ;
	setAttr ".tk[79]" -type "float3" -0.088274367 -1.0105466e-08 0 ;
	setAttr ".tk[80]" -type "float3" -0.076447845 -1.0105466e-08 0.04413718 ;
	setAttr ".tk[81]" -type "float3" -0.044137206 -1.0105466e-08 0.07644783 ;
	setAttr ".tk[82]" -type "float3" -1.5784687e-08 -1.0105466e-08 0.08827436 ;
	setAttr ".tk[83]" -type "float3" 0.04413718 -1.0105466e-08 0.07644783 ;
	setAttr ".tk[84]" -type "float3" 0.076447807 -1.0105466e-08 0.04413718 ;
	setAttr ".tk[85]" -type "float3" 0.088274367 -1.0105466e-08 0 ;
...
createNode polyTweak -n "polyTweak19";
	...
	setAttr ".uopa" yes;
	setAttr -s 6 ".tk";
	setAttr ".tk[16]" -type "float3" 0 -1.3715543 0 ;
	setAttr ".tk[17]" -type "float3" 0 -1.3715543 0 ;
	setAttr ".tk[18]" -type "float3" 0 -1.3715543 0 ;
	setAttr ".tk[19]" -type "float3" 0 -1.3715543 0 ;
