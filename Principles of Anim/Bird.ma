...
//Name: Bird.ma
//Last modified: Fri, Sep 07, 2018 12:48:03 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -15.254849887760503 6.1996828293485411 4.4005415066917983 ;
	setAttr ".r" -type "double3" -26.738352774710819 -71.000000000155907 -4.8846219108742698e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "6CF8A2EC-439B-61D1-360F-5886A92530C6";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.497733226539067;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.6768250475877915 -0.28237148483069174 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "9BCF1B5E-4267-B2A3-5313-9EB8A6DD350B";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 6.7758158801322894;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.25 0.015625 ;
	...
	setAttr ".pt[340]" -type "float3" 0.0041625574 0.0038586252 0 ;
	setAttr ".pt[341]" -type "float3" 0.0041625574 0.0038586252 0 ;
	setAttr ".pt[342]" -type "float3" 0.0041625574 0.0038586252 0 ;
	setAttr ".pt[343]" -type "float3" 0.0041625574 0.0038586252 0 ;
	setAttr ".pt[344]" -type "float3" 0.0041625574 0.0038586252 0 ;
	setAttr ".pt[345]" -type "float3" 0.0041625574 0.0038586252 0 ;
	setAttr ".pt[346]" -type "float3" 0.0041625574 0.0038586252 0 ;
